...
<footer
    class="bg-purple-400 min-h-24 w-full p-2 flex justify-center items-center gap-2"
>
    ...
    >
    <iframe
        src="https://ghbtns.com/github-btn.html?user=bagusindrayana&repo=hashire-svelte&type=star&count=true&size=large"
        frameborder="0"
        scrolling="0"
        width="170"
        height="30"
